...
fonts:
	@sudo apt install -y ttf-bitstream-vera fonts-terminus fonts-roboto \
											 fonts-lato fonts-liberation fonts-hack fonts-inconsolata \
											 fonts-firacode fonts-open-sans fonts-powerline
	@mkdir -p ~/.fonts
